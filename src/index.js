        ...
        if (value) {
          styleProfile = document.createElement("style").appendChild(
            ...
            .topSectionXbox-3fWLjS {
              z-index: 1;
              background: url(https://cdn.naila.bot/Discord/playing-background.svg), #107c10;
            }
            .topSectionPlaying-1J5E4n,
            .topSectionSpotify-1lI0-P,
            .topSectionStreaming-1Tpf5X,
    ...
    onImport: async () => {
      ...
      goosemodScope.settings.createItem(name, [
        ...
        },
        {
          type: "toggle",
          text: "Pings Count",
          onToggle: (value) => updateSetting("pings", value),
          isToggled: () => settings.pings,
        },
        {
          type: "toggle",
          text: "Modals",
          onToggle: (value) => updateSetting("modals", value),
          isToggled: () => settings.modals,
        },
        {
          type: "toggle",
          text: "Profile Modal",
          onToggle: (value) => updateSetting("profile", value),
          isToggled: () => settings.profile,
        },
        {
          type: "toggle",
          text: "Channel Mute Button",
          onToggle: (value) => updateSetting("channelMute", value),
          isToggled: () => settings.channelMute,
        },
        {
          type: "toggle",
          text: "Call Button",
          onToggle: (value) => updateSetting("call", value),
          isToggled: () => settings.call,
        },
        {
          type: "toggle",
          text: "Pins Button",
          onToggle: (value) => updateSetting("pins", value),
          isToggled: () => settings.pins,
        },
        {
          type: "toggle",
          text: "Update Button",
          onToggle: (value) => updateSetting("update", value),
          isToggled: () => settings.update,
        },
        {
          type: "toggle",
          text: "User Buttons",
          onToggle: (value) => updateSetting("userButtons", value),
